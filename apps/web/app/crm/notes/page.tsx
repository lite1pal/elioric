...
export default async function ResourcePage({ searchParams }: ResourcePageProps) {
  ...
  const data = await loadNoteWorkspacePage(resolvedSearchParams, {
    currentUser
  });
  ...
  return (
    ...
    >
      <div className="grid gap-6">
        ...
        <NoteForm action={createNoteWorkspaceAction} defaultValues={data.draftValues} submitLabel="Create Note">
