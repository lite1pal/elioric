...
export function ContactTable(input: {
...
function buildResourceHref(
  input: Pick<ContactTableParameters, "organizationId" | "projectId" | "resourceBasePath" | "resourceQuery">,
  id: string
) {
...
interface ContactTableParameters {
  items: readonly ContactRecord[];
  organizationId?: string;
  projectId?: string;
  relationPresentations?: ContactRelationPresentations;
