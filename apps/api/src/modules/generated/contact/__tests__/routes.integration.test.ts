...
describe("contact generated resource integration", () => {
  ...
  it("creates, lists, reads, updates, and deletes contacts through the installed API routes", async () => {
    ...
    const getResponse = await app.inject({
      ...
      url: `${API_VERSION_PREFIX}/organizations/${session.organizationId}/contacts/${createdId}`
    });
    ...
    const archiveResponse = await app.inject({
      ...
      url: `${API_VERSION_PREFIX}/organizations/${session.organizationId}/contacts/${createdId}/archive`
    });
    ...
    const archivedOnlyResponse = await app.inject({
      ...
      url: `${API_VERSION_PREFIX}/organizations/${session.organizationId}/contacts?archived=only`
    });
    ...
    const unarchiveResponse = await app.inject({
      ...
      url: `${API_VERSION_PREFIX}/organizations/${session.organizationId}/contacts/${createdId}/unarchive`
    });
  ...
  it("does not expose contacts across organizations", async () => {
    const session = await createSessionMember();
    ...
    const response = await app.inject({
      ...
      url: `${API_VERSION_PREFIX}/organizations/${otherOrganization.id}/contacts`
    });
