...
describe("note generated resource integration", () => {
  ...
  it("creates, lists, reads, updates, and deletes notes through the installed API routes", async () => {
    ...
    const getResponse = await app.inject({
      ...
      url: `${API_VERSION_PREFIX}/organizations/${session.organizationId}/notes/${createdId}`
    });
    ...
    const archiveResponse = await app.inject({
      ...
      url: `${API_VERSION_PREFIX}/organizations/${session.organizationId}/notes/${createdId}/archive`
    });
    ...
    const archivedOnlyResponse = await app.inject({
      ...
      url: `${API_VERSION_PREFIX}/organizations/${session.organizationId}/notes?archived=only`
    });
    ...
    const unarchiveResponse = await app.inject({
      ...
      url: `${API_VERSION_PREFIX}/organizations/${session.organizationId}/notes/${createdId}/unarchive`
    });
  ...
  it("does not expose notes across organizations", async () => {
    const session = await createSessionMember();
    ...
    const response = await app.inject({
      ...
      url: `${API_VERSION_PREFIX}/organizations/${otherOrganization.id}/notes`
    });
