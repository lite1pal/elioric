...
describe("deal generated resource integration", () => {
  ...
  it("creates, lists, reads, updates, and deletes deals through the installed API routes", async () => {
    ...
    const getResponse = await app.inject({
      ...
      url: `${API_VERSION_PREFIX}/organizations/${session.organizationId}/deals/${createdId}`
    });
    ...
    const archiveResponse = await app.inject({
      ...
      url: `${API_VERSION_PREFIX}/organizations/${session.organizationId}/deals/${createdId}/archive`
    });
    ...
    const archivedOnlyResponse = await app.inject({
      ...
      url: `${API_VERSION_PREFIX}/organizations/${session.organizationId}/deals?archived=only`
    });
    ...
    const unarchiveResponse = await app.inject({
      ...
      url: `${API_VERSION_PREFIX}/organizations/${session.organizationId}/deals/${createdId}/unarchive`
    });
  ...
  it("does not expose deals across organizations", async () => {
    const session = await createSessionMember();
    ...
    const response = await app.inject({
      ...
      url: `${API_VERSION_PREFIX}/organizations/${otherOrganization.id}/deals`
    });
