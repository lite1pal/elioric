...
describe("company generated resource integration", () => {
  ...
  it("creates, lists, reads, updates, and deletes companies through the installed API routes", async () => {
    ...
    const getResponse = await app.inject({
      ...
      url: `${API_VERSION_PREFIX}/organizations/${session.organizationId}/companies/${createdId}`
    });
    ...
    const archiveResponse = await app.inject({
      ...
      url: `${API_VERSION_PREFIX}/organizations/${session.organizationId}/companies/${createdId}/archive`
    });
    ...
    const archivedOnlyResponse = await app.inject({
      ...
      url: `${API_VERSION_PREFIX}/organizations/${session.organizationId}/companies?archived=only`
    });
    ...
    const unarchiveResponse = await app.inject({
      ...
      url: `${API_VERSION_PREFIX}/organizations/${session.organizationId}/companies/${createdId}/unarchive`
    });
  ...
  it("does not expose companies across organizations", async () => {
    const session = await createSessionMember();
    ...
    const response = await app.inject({
      ...
      url: `${API_VERSION_PREFIX}/organizations/${otherOrganization.id}/companies`
    });
