...
- business rules: `apps/api/src/modules/generated/deal/service.ts`
- persistence queries: `apps/api/src/modules/generated/deal/postgres-repo.ts`
- request validation and route shaping: `apps/api/src/modules/generated/deal/routes.ts`
- UI copy and layout: `apps/web/src/features/deal/components/*`
