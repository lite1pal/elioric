...
- business rules: `apps/api/src/modules/generated/contact/service.ts`
- persistence queries: `apps/api/src/modules/generated/contact/postgres-repo.ts`
- request validation and route shaping: `apps/api/src/modules/generated/contact/routes.ts`
- UI copy and layout: `apps/web/src/features/contact/components/*`
