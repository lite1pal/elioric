...
- business rules: `apps/api/src/modules/generated/company/service.ts`
- persistence queries: `apps/api/src/modules/generated/company/postgres-repo.ts`
- request validation and route shaping: `apps/api/src/modules/generated/company/routes.ts`
- UI copy and layout: `apps/web/src/features/company/components/*`
