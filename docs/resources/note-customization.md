...
- business rules: `apps/api/src/modules/generated/note/service.ts`
- persistence queries: `apps/api/src/modules/generated/note/postgres-repo.ts`
- request validation and route shaping: `apps/api/src/modules/generated/note/routes.ts`
- UI copy and layout: `apps/web/src/features/note/components/*`
